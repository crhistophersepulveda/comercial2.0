...
<head>
    ...
    <!-- MetisMenu CSS -->
    <link href="<?php echo base_url(); ?>assets/ower_components/metisMenu/dist/metisMenu.min.css" rel="stylesheet">
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Buscar Artículo</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
